            ...
            <ProductCard>
                ...
                <div className="product-image">
                    ...
                    <div className='favourite'>
                        <Button style={{width: '20px', height: '20px', padding: '0', backgroundColor: 'transparent', border: 'none'}}>
                        <svg  viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width='2' ><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                        </Button>
                    </div>
                ...
                <div className="product-info">
                    ...
                    <div className="product-name" >
                        <span style={{fontWeight: "500"}}>Quần jeans nữ cotton cài cúc dáng suông</span>
                    </div>
                    <div className="product-price">
                        <span>319.000₫</span>
                        <div style={{display: 'flex', alignItems: 'center', gap: '6px',}}>
                            <p>399.000₫</p>
                            <div className='sale-off' style={{ backgroundColor: '#FEEEEA', width: '30px', height: '14px', justifyContent: 'center', alignItems: 'center', display: 'flex'}}>
                                <p style={{fontSize: '10px' ,padding: '0px 0px', color: 'red', textDecoration: 'none'}}>-20%</p>
                            </div>
                        </div>
                    </div>
