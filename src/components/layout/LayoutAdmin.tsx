...
const LayoutAdmin = (props: IProps) => {
    ...
    useEffect(() => {
        ...
        if (permissions?.length || ACL_ENABLE === 'false') {
            ...
            const full = [
                {
                    label: <Link to='/admin/'><p className='layout-admin__p'>Tổng quan</p></Link>,
                    key: '/admin',
                ...
                ...(viewUser || ACL_ENABLE === 'false' ? [{
                    label: <p className='layout-admin__p'>Khách Hàng</p>,
                    ...
                    children: [
                        {   
                            ...
                            label: <Link to='/admin/user-management/users'><p></p></Link>, // Quản lý tài khoản người dùng
                ...
                ...(viewRole || ACL_ENABLE === 'false' ? [{
                    label: <p className='layout-admin__p'>Sản Phẩm</p>,
                    ...
                    children: [ 
                        ...
                        {
                            label: <Link to='/admin/product-management/new-product'>Add Product</Link>, 
            ...
            >
                {!isMobile ?
                    <Sider
                        ...
                        <Menu
                            style={{ backgroundColor: 'rgb(24, 37, 55)' }}
