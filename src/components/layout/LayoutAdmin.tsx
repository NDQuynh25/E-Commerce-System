      ...
      const full = [
        {
          ...
          icon: (
            ...
            >
              <path
                fill="currentColor"
                d="m21.477 9.085-7.413-6.1a3.26 3.26 0 0 0-4.128 0l-7.413 6.1a.75.75 0 1 0 .954 1.158l.773-.636v8.393a3.383 3.383 0 0 0 3.75 3.75h8a3.382 3.382 0 0 0 3.75-3.75v-8.393l.773.636a.75.75 0 0 0 .954-1.158m-7.727 11.165h-3.5v-3.75a1.75 1.75 0 0 1 3.5 0zm4.5-2.25c0 1.577-.673 2.25-2.25 2.25h-.75v-3.75a3.25 3.25 0 0 0-6.5 0v3.75h-.75c-1.577 0-2.25-.673-2.25-2.25v-9.626l5.139-4.226a1.755 1.755 0 0 1 2.222 0l5.139 4.226z"
              ></path>
            </svg>
          ),
        },
          ...
          ? [
              {
                ...
                icon: (
                  ...
                  >
                    ...
                    <path
                      fill="currentColor"
                      d="M12.01 10.75a4.25 4.25 0 1 1 0-8.5 4.25 4.25 0 0 1 0 8.5m0-7a2.75 2.75 0 1 0 0 5.5 2.75 2.75 0 0 0 0-5.5m3.99 18h-8c-2.42 0-3.753-1.325-3.753-3.731 0-2.662 1.506-5.769 5.75-5.769h4c4.244 0 5.75 3.107 5.75 5.769.003 2.406-1.33 3.731-3.747 3.731m-6-8a3.957 3.957 0 0 0-4.25 4.269c0 1.564.674 2.231 2.253 2.231h7.997c1.58 0 2.253-.667 2.253-2.231a3.96 3.96 0 0 0-4.253-4.269z"
                    ></path>
                  </svg>
                ),
                ...
                children: [
                  ...
                  {
                    label: (
                      <Link to="/admin/user-management/roles">
                        Nhóm phân quyền
                      </Link>
                  ...
                  {
                    label: (
                      <Link to="/admin/user-management/permissions">
                        Quyền hạn
                      </Link>
          ...
          >
            {collapsed ? (
              ...
              >
                <img
                  style={{ width: "35px" }}
                  src="https://res.cloudinary.com/dbu3hnaiz/image/upload/v1740830322/l7ejzdcf_ybef7e.png"
                />
              </div>
            ) : (
              <div
              ...
              >
                <img
                  style={{ width: "135px" }}
                  src="https://bizweb.dktcdn.net/100/480/479/themes/900388/assets/logo.png?1727161994343"
                />
              </div>
            )}
