            ...
            <div className="container">
                <div className="top-bar-content">
                    <div className="top-bar-left">
                        <div className="top-bar-item">
                            <a href="tel:10991006" title="10991006">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512" fill="orange">
                    ...
                    <div className="top-bar-right">
                        ...
                        <div className="top-bar-item">
                            <Link to="#"><span>Đăng ký</span></Link>
                        </div>
                        <div className="top-bar-item">
                            <Link to="/cart"><span>Hệ thống cửa hàng</span></Link>
                        </div>
                        <div className="top-bar-item">
                            <Link to="/cart"><span>FAQ</span></Link>
                        </div>
                        <div className="top-bar-item">
                            <Link to="#"><span>Sản phẩm yêu thích</span></Link>
                        </div>
                    </div>
                </div>
            </div>
