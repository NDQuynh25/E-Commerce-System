...
import { IProduct, ProductType } from "../../types/backend";
import {
  DeleteOutlined,
  EditOutlined,
  PlusOutlined,
...
const ProductManagement = () => {
  ...
  const columns: ProColumns<IProduct>[] = [
    ...
    {
      title: (
        <span style={{ fontSize: "15px", fontWeight: "600" }}>Sản phẩm</span>
      ),
      ...
      render: (text, record, index, action) => {
        return (
          <div style={{ display: "flex", gap: "10px", alignItems: "center" }}>
            <img
              src={
                "https://res.cloudinary.com/dbu3hnaiz/image/upload/v1738775928/z51cfnhq6ihkhxtgwyzr.jpg"
              }
    ...
    {
      title: (
        <span style={{ fontSize: "15px", fontWeight: "600" }}>Thao tác</span>
      ),
      hideInSearch: true,
      width: 80,
      align: "center",
  ...
  const buildQuery = (params: any, sort: any, filter: any) => {
    ...
    if (clone.productName)
      q.filter = `${sfLike("productName", clone.productName)}`;
