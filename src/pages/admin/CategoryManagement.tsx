...
const CategoryManagement = () => {
  ...
  const columns: ProColumns<CategoryType>[] = [
    ...
    {
      title: (
        <span style={{ fontSize: "15px", fontWeight: "600" }}>Danh mục</span>
      ),
    ...
    {
      title: (
        <span style={{ fontSize: "15px", fontWeight: "600" }}>Số lượng</span>
      ),
  ...
  const buildQuery = (params: any, sort: any, filter: any) => {
    ...
    if (clone.categoryName)
      q.filter = `${sfLike("categoryName", clone.categoryName)}`;
